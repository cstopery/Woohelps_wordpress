    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8">
                ...
                <?php
                //TODO: 把meetup-calendar.php 和 content-archive-topic.php 共通活动模版提取出来。
                    ...
                    <li class="list-group-item" style="margin-bottom: 1px;">
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-xs-12">
                                <a class="text-muted"
                                   href="<?= $topics[$key]->forum['link'] ?>"><?= $topics[$key]->forum['name'] ?></a>
                                <h4 style="margin: 5px 0;"><a
                                        href="<?= bbp_get_topic_permalink($id) ?>"><?= $topics[$key]->post_title ?></a>
                                </h4>
                                <p style="margin: 0;">
